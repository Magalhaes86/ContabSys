...
namespace ContabSys
{
    public partial class addRecepcaoSafts : Form
    {
        ...
        {
            string insertQuery = "INSERT INTO recepcaosaft (CodCliente,Data,Obs) VALUES('" + tbidcliente.Text + "','" + dateTimePicker1.Text + "','" + tbobs.Text + "');";
            executeMyQuery(insertQuery);
        }

        private void btnUPDATE_Click(object sender, EventArgs e)
        {
            string updateQuery = "UPDATE recepcaosaft SET CodCliente='" + tbidcliente.Text + "',Data='" + dateTimePicker1.Text + "',Obs='" + tbobs.Text + "' WHERE ID =" + int.Parse(tbcodcliente.Text);
