...
namespace ContabSys
{
    public partial class listagemClientesSeleccaoEArguivos : Form
    {
        public listagemClientesSeleccaoEArguivos()
        {
            InitializeComponent();
        }
        ...
        private void listagemClientesSeleccaoEArguivos_Load(object sender, EventArgs e)
        {
