...
namespace ContabSys
{
    public partial class addRecebimentos : Form
    {
        public addRecebimentos()
        {
            InitializeComponent();
        }
        ...
        private void addRecebimentos_Load(object sender, EventArgs e)
        {
        ...
        private void btnRemover_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                string udeleteQuery = "DELETE FROM recebimentos WHERE ID =" + int.Parse(tbcodcliente.Text);
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                tbobs.Text = "";
                tbvalor.Text = "";
                ListClientesRecebimentos frmListClientesRecebimentos = new ListClientesRecebimentos();
                frmListClientesRecebimentos.ShowDialog();
